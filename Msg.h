...
public:
	...
	enum MSG_TYPE {
		...
		/////////////////////////////////////////////////////////////////////
		// 초기화 메시지
		// 서버가 accept 하면서 응답으로 보내며, Major 버전값과 사람 수를 송신한다
		...
		// 형식 : encode된 rule string(s)	// v4.0.1에서 바뀜(2010.6.30)
		// + 게임 규칙 이름(s)
		...
		/////////////////////////////////////////////////////////////////////
		// 자리를 다시 섞어 보낸다
		// 한 게임마다 자리를 다시 섞는 옵션을 선택한 경우에 서버에서 보내줌
		// 형식 : 보낸 사람 UID(l)
		mmRandomSeat = 107,
		
		/////////////////////////////////////////////////////////////////////
		// 누군가가 접속 종료
		// 형식 : 보낸 사람 UID(l), 기다리는 사람 수(l), 나간 사람들의 ID(s) x 기다리는 사람 수
		mmDisconnect = 108,
