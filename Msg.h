...
public:
	...
	enum MSG_TYPE {
		...
		/////////////////////////////////////////////////////////////////////
		// 자리 섞기 메시지
		// 형식 : 보낸 사람 UID(l), n번 플레이어의 위치(l) x 인원 수
		mmGameSeat = 100,
		...
		mmGameKillOneFromSix = 103,

		/////////////////////////////////////////////////////////////////////
		// 죽인후 카드 섞기 메시지
		// 형식 : 보낸 사람 UID(l), 덱 (C)
		mmGameSuffledForDead = 104,
		...
		// 공개된 프렌드
		// 형식 : 프렌드 위치(l)
		mmRevealedFriend = 207,

		/////////////////////////////////////////////////////////////////////
		// 카드를 내시오 / 카드를 냈다
		// 형식 : 서버->클라인 경우 없음, 클라->서버인 경우 내는 카드(l)
		mmSetCard = 210,

		/////////////////////////////////////////////////////////////////////
		// 공약을 내시오 / 공약을 냈다
		// 형식 : 서버->클라인 경우 없음, 클라->서버인 경우 공약(l)
		mmSetCommit = 211,

		/////////////////////////////////////////////////////////////////////
		// n장 버리시오 / n장을 버린다
		// 형식 : 서버->클라인 경우 버려야 하는 장수(l), 클라->서버인 경우 버리는 카드(lx1 or lx3)
		mmSetDiscard = 212,

		/////////////////////////////////////////////////////////////////////
		// 프렌드를 정하시오 / 프렌드를 정했다
		// 형식 : 서버->클라인 경우 없음, 클라->서버인 경우 프렌드(l)
		mmSetFriend = 213,
		...
		/////////////////////////////////////////////////////////////////////
		// 채팅 메시지
		// 형식 : 보낸 사람 UID(l), 보낸 사람 이름(s), 메시지 내용(s)
		// v4.0에서 자리 섞는 기능을 제대로 하기 위해 바꾸었다. (2011.3.1)
		mmChat = 1000,
